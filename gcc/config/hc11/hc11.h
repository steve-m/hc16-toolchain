/* $Id: hc11.h,v 1.10 2011/05/01 23:12:47 querbach Exp $ */
/* Definitions of target machine for GNU compiler.  Motorola 68HC11 version.
...
/* FIXME Doesn't work under cygwin32
#define abort()								\
(               	        					\
  (									\
    (__INCLUDE_LEVEL__) ? 						\
...
#define CPP_PREDEFINES "-Dmc68hc11 					\
			-DMC68HC11					\
			-Dhc11						\
			-DHC11"
...
#define TARGET_VERSION fprintf (stderr, " (MC68HC11, GAS syntax)");
...
#define FIXED_REGISTERS { 0, 0, 1, 1, 1 }
...
{									\
  int overhead = 4;							\
									\
  if (FROM == STACK_POINTER_REGNUM && TO == FRAME_POINTER_REGNUM)	\
    (OFFSET) = 0;							\
									\
